...
export default function GameSidebarItem({ icon, khmer, subtitle, active = false, onClick, className }: GameSidebarItemProps) {
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'flex min-w-44 items-center gap-3 rounded-[24px] border-[3px] border-[#74451C]/60 bg-gradient-to-b from-[#FFF4CE] via-[#F6D184] to-[#D79948] p-3 text-left shadow-[inset_0_-5px_0_rgba(92,55,25,.18),0_13px_22px_rgba(33,81,107,.2)] transition hover:-translate-y-0.5 xl:min-w-0 xl:flex-col xl:text-center',
